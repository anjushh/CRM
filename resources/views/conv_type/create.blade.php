...
<div class="col-lg-12">
    <div class="card">
        <div class="card-header">
            <div class="col-9">
                <div class="master-subhead"><strong>Conversation Type</strong> Master</div>
            </div>
        </div>
        <div class="card-body card-block">
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                <div class="form-group">
                    ...
                    {!! Form::model($edit_records, ['method' => 'PATCH','route' => ['conv_type.update', $edit_records->id]]) !!}
                    @else
                    {!! Form::open(array('route' => 'conv_type.store','method'=>'POST','files'=>true)) !!}
                    @endif
                    {!! Form::text('conv_type', Input::old('conv_type'), array('placeholder' => 'Enter Conversation Type','class' => 'form-control d-inline-block w-70 float-left')) !!}
            ...
            <div class="card-body">
                <table class="table table-responsive table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ ++$i }}</td>
                            <td>{{ $create_record->conv_type }}</td>
                            <td>
                                <a class="btn btn-success btn-sm" href="{{ route('conv_type.edit', $create_record->id) }}"><i class="fa fa-edit"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
